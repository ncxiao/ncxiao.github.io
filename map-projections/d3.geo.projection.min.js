!function() {
    ...
    function v(t) {
        function n(t, n) {
            var e = Math.cos(n), o = Math.cos(t/=2);
    ...
    function l() {
        function t(t) {
            ...
            return n.push(n[0]), t.clipPolygon([n])
        }
        var n = fa / 9, a = n > 0 ? 1: - 1, r = Math.tan(a * n), e = pa(v), o = e(n);
        return o.parallel = function(o) {
            return arguments.length ? (r = Math.tan((a = (n = o * fa / 180) > 0 ? 1 : - 1) * n), t(e(n))) : n / fa * 180
        }, t(o)
    }
    function g(t) {
    ...
    function S() {
        ...
        return a.lobes = function(a) {
            ...
            return a.rotate(u), M.sphere = function() {
                ...
                for (var n = 0, a = 360 / t, r = 2 * fa / t, u = 90 - 180 / t, M = va; t > n; ++n, u -= a, M -= r)
                    s.point(Math.atan2(i * Math.cos(M), o) * da, h(i * Math.sin(M)) * da), - 90 > u ? (s.point( - 90, - 180 - u - e), s.point( - 90, - 180 - u + e)) : (s.point(90, u + e), s.point(90, u - e));
    ...
    function k(t) {
        function n(n, a) {
            for (var r = Math.sin(a), e = Math.cos(a), o = new Array(3), M = 0; 3 > M; ++M) {
                var s = t[M];
                if (o[M] = z(a - s[1], s[3], s[2], e, r, n - s[0]), !o[M][0])
                    return s.point;
                o[M][1] = F(o[M][1] - s.v[1])
            }
        ...
        for (var a, r = t[2], e = 0; 3 > e; ++e, r = a)
            a = t[e], r.v = z(a[1] - r[1], r[3], r[2], a[3], a[2], a[0] - r[0]), r.point = [0, 0];
    ...
    function _() {
        var t = [[0, 0], [0, 0], [0, 0]], n = pa(k), a = n(t), r = a.rotate;
    ...
    function X(t, n, a, r, e, o, i, h) {
        ...
        return arguments.length < 8 && (h = 0), u.invert = function(u, s) {
            ...
            do {
                var d = l * l, b = t + d * (n + d * (a + d * r)), p = l * (e - 1 + d * (o - h + d * i)), w = b * b + p * p, q = 2 * p, m = w / q, y = m * m, S = Math.asin(b / m) / fa, Q = v * S;
                if (xB2 = b * b, dxBdφ = (2 * n + d * (4 * a + 6 * d * r)
                    ) * l, dyBdφ = e + d * (3 * o + 5 * d * i), dpdφ = 2 * (b * dxBdφ + p * (dyBdφ - 1)), dqdφ = 2 * (dyBdφ - 1), dmdφ = (dpdφ * q - w * dqdφ) / (q * q), cosα = Math.cos(Q), sinα = Math.sin(Q), mcosα = m * cosα, msinα = m * sinα, dαdφ = v / fa * (1 / M(1 - xB2 / y)) * (dxBdφ * m - b * dmdφ) / y, fx = msinα - u, fy = l * (1 + d * h) + m - mcosα - s, δxδφ = dmdφ * sinα + mcosα * dαdφ, δxδλ = mcosα * S, δyδφ = 1 + dmdφ - (dmdφ * cosα - msinα * dαdφ), δyδλ = msinα * S, denominator = δxδφ * δyδλ - δyδφ * δxδλ, !denominator)break;
    ...
    function Z(t) {
        ...
        function a(n) {
            var a = n ? function(n, a) {
                var e = Math.abs(n) < va, o = t(e ? n : n > 0 ? n - fa : n + fa, a), h = (o[0] - o[1]) * Math.SQRT1_2, u = (o[0] + o[1]) * Math.SQRT1_2;
                if (e)
                    return [h, u];
    ...
    function tn(t, n) {
        ...
        if (0 === t)
            return [0, - (d + r * g)];
        var b = Math.cos(n), p = 1 / b, w = 2 * a * b, q = ( - 3 * r + s * i) * w, m = ( - c * b - (1 - a) * q) / (c * c), y = .5 * m / v, S = u * y - 2 * r * v * w, Q = r * o * m + f * i * w, R =- p * w, T =- p * Q, x =- 2 * p * S, E = 4 * t / fa;
    ...
    function rn(t, n) {
        var a, r, e, o, i;
        if (sa > n)
            return o = Math.sin(t), r = Math.cos(t), a = .25 * n * (t - o * r), [o - a * r, r + a * o, 1 - .5 * n * o * o, t - a];
        if (n >= 1 - sa)
            return a = .25 * (1 - n), r = b(t), o = g(t), e = 1 / r, i = r * d(t), [o + a * (i - t) / (r * r), e - a * o * e * (i - t), e + a * o * e * (i + t), 2 * Math.atan(Math.exp(t)) - va + a * (i - t) / r];
        var u = [1, 0, 0, 0, 0, 0, 0, 0, 0], s = [Math.sqrt(n), 0, 0, 0, 0, 0, 0, 0, 0], c = 0;
        for (r = Math.sqrt(1 - n), i = 1; Math.abs(s[c] / u[c]) > sa && 8 > c;)
            a = u[c++], s[c] = .5 * (a - r), u[c] = .5 * (a + r), r = M(a * r), i*=2;
        e = i * u[c] * t;
        do 
            o = s[c] * Math.sin(r = e) / u[c], e = .5 * (h(o) + e);
        while (--c);
    ...
    function hn(t, n) {
        var a = (Math.SQRT2 - 1) / (Math.SQRT2 + 1), r = Math.sqrt(1 - a * a), e = on(va, r * r), o =- 1, i = Math.log(Math.tan(fa / 4 + Math.abs(n) / 2)), h = Math.exp(o * i) / Math.sqrt(a), u = un(h * Math.cos(o * t), h * Math.sin(o * t)), M = en(u[0], u[1], r * r);
    ...
    function sn(t) {
        function n(t, n) {
            var o = e(t, n);
            t = o[0], n = o[1];
            var i = Math.sin(n), h = Math.cos(n), M = Math.cos(t), s = u(a * i + r * h * M), c = Math.sin(s), f = Math.abs(c) > sa ? s / c: 1;
        ...
        return e.invert = cn( - t), n.invert = function(t, n) {
            var r = Math.sqrt(t * t + n * n), o =- Math.sin(r), i = Math.cos(r), h = r * i, u =- n * o, s = r * a, c = M(h * h + u * u - s * s), f = Math.atan2(h * s + u * c, u * s - h * c), v = (r > va?-1 : 1) * Math.atan2(t * o, r * Math.cos(f) * i + n * Math.sin(f) * o);
            return e.invert(v, f)
        }, n
    }
    function cn(t) {
    ...
    function fn() {
        var t = 0, n = pa(sn), a = n(t), r = a.rotate, e = a.stream, o = d3.geo.circle();
        return a.parallel = function(r) {
            ...
            return t = e(t), t.sphere = function() {
                ...
                for (t.polygonStart(), t.lineStart(); ++i < e;)
                    t.point((n = r[i])[0], n[1]);
                for (t.lineEnd(), t.polygonEnd(), r = o.angle(90 + a)().coordinates[0], e = r.length - 1, t.polygonStart(), t.lineStart(); --i >= 0;)
                    t.point((n = r[i])[0], n[1]);
    ...
    function bn(t) {
        ...
        var a = d3.geo.cylindricalEqualArea.raw(0), r = _a * fa / 180, e = 2 * fa, o = d3.geo.collignon.raw(fa, r)[0] - d3.geo.collignon.raw( - fa, r)[0], i = a(0, r)[1], h = d3.geo.collignon.raw(0, r)[1], u = d3.geo.collignon.raw(0, va)[1] - h, M = 2 * fa / t;
        return n.invert = function(n, r) {
            n*=2;
            var s = Math.abs(r);
            if (s > i) {
    ...
    function pn() {
        ...
        var n = 2, a = pa(bn), r = a(n), e = r.stream;
    ...
    function Pn(t) {
        function n(n, e) {
            var o = e - t, i = Math.abs(o) < sa ? n * a: Math.abs(i = fa / 4 + e / 2) < sa || Math.abs(Math.abs(i) - va) < sa ? 0: n * o / Math.log(Math.tan(i) / r);
            return [i, o]
        }
        ...
        return n.invert = function(n, r) {
            ...
            do {
                for (var u, M = a, s = t[M], c = s[0], f = s[1], v = 0, l = 0; --M >= 0;)
                    s = t[M], v = c + o * (u = v) - i * l, l = f + o * l + i * u, c = s[0] + o * (u = c) - i * f, f = s[1] + o * f + i * u;
    ...
    function Dn(t) {
        ...
        return n.invert = function(n, r) {
            ...
            var v = n * (s = Math.tan(i)), l = Math.tan(Math.abs(r) < Math.abs(i + 1 / s) ? .5 * h(v) : .5 * u(v) + fa / 4) / Math.sin(i);
    ...
    function Nn() {
        var t = [[0, 0], [0, 0]], n = pa(Kn), a = n(0), r = a.rotate;
        return delete a.rotate, a.points = function(a) {
            if (!arguments.length)
                return t;
            t = a;
            var e = d3.geo.interpolate(a[0], a[1]), o = e(.5), i = d3.geo.rotation([ - o[0], - o[1]])(a[0]), u = .5 * e.distance, M =- h(Math.sin(i[1] * ga) / Math.sin(u));
            return i[0] > 0 && (M = fa - M), r.call(i, [ - o[0], - o[1], - M * da]), n(2 * u)
        }, a
    }
    function Un(t) {
        function n(t, n) {
    ...
    function Vn() {
        var t = [[0, 0], [0, 0]], n = pa(Un), a = n(0), r = a.rotate;
        return delete a.rotate, a.points = function(a) {
            if (!arguments.length)
                return t;
            t = a;
            var e = d3.geo.interpolate(a[0], a[1]), o = e(.5), i = d3.geo.rotation([ - o[0], - o[1]])(a[0]), u = .5 * e.distance, M = (i[0] < 0?-1 : 1) * i[1] * ga, s = h(Math.sin(M) / Math.sin(u));
    ...
    function Wn(t, n) {
        if (Math.abs(n) < sa)
            return [t, 0];
        var a = Math.abs(n / va), r = h(a);
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - va) < sa)
            return [0, i(n) * fa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(fa / t - t / fa) / 2, u = o * o, M = e / (a + e - 1), s = M * (2 / a - 1), c = s * s, f = c + u, v = M - c, l = u + M;
    ...
    function Xn(t, n) {
        ...
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - va) < sa)
            return [0, i(n) * fa * Math.tan(r / 2)];
        var e = Math.cos(r), o = Math.abs(fa / t - t / fa) / 2, u = o * o, s = e * (Math.sqrt(1 + u) - o * e) / (1 + u * a * a);
    ...
    function Zn(t, n) {
        ...
        if (!t || a === va)
            return [0, n];
        var r = a / va, e = r * r, o = (8 * r - e * (e + 2) - 5) / (2 * e * (r - 1)), h = o * o, u = r * o, s = e + h + 2 * u, c = r + 3 * o, f = t / va, v = f + 1 / f, l = i(Math.abs(t) - va) * Math.sqrt(v * v - 4), g = l * l, d = s * (e + h * g - 1) + (1 - e) * (e * (c * c + 4 * h) + 12 * u * h + 4 * h * h), b = (l * (s + h - 1) + 2 * M(d)) / (4 * s + g);
    ...
    var ra = {
        ...
        MultiPolygon: ua,
        Sphere: ua
    }, sa = 1e-6, ca = sa * sa, fa = Math.PI, va = fa / 2, la = Math.sqrt(fa), ga = fa / 180, da = 180 / fa, ba = d3.geo.projection, pa = d3.geo.projectionMutator;
    ...
    (d3.geo.mollweide = function() {
        ...
        do 
            r = o - Math.SQRT2 * Math.sin(i), i -= a = (Math.sin(2 * i) + 2 * i - fa * Math.sin(r)) / (2 * Math.cos(2 * i) + 2 + fa * Math.cos(r) * Math.SQRT2 * Math.cos(i));
    ...
    mn.invert = function(t, n) {
        ...
        for (var h = 0; 25 > h; h++) {
            ...
            if (i -= S, o -= Q, Math.abs(S) < sa && Math.abs(Q) < sa)
                break
        }
    ...
    Ga.forEach(function(t) {
        ...
        do {
            ...
            if (v >= 0 || 1 === o) {
                ...
                var l, g = 50;
                do 
                    e = Math.min(18, Math.abs(r) / 5), o = Math.floor(e), v = e - o, i = Ga[o][1], h = Ga[o + 1][1], u = Ga[Math.min(19, o + 2)][1], r -= (l = (n >= 0 ? va : - va) * (h + v * (u - i) / 2 + v * v * (u - 2 * h + i) / 2) - n) * da;
